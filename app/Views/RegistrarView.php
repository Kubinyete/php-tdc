...
final class RegistrarView extends ViewBase {
	public function __construct(?Usuario $usuario = null, ?string $login = null, ?string $loginErro = null, ?string $senha = null, ?string $senhaErro = null, ?string $confirmaSenha = null, ?string $confirmaSenhaErro = null) {
