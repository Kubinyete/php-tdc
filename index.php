...
App\Log\AppLog::log(App\Log\Notificacao::INFO, 'APP_BASE: '.APP_BASE);

App\Log\AppLog::log(App\Log\Notificacao::INFO, 'APP_VER: '.APP_VER);

App\Log\AppLog::log(App\Log\Notificacao::INFO, 'WEB_HOST: '.WEB_HOST);

App\Log\AppLog::log(App\Log\Notificacao::INFO, 'WEB_BASE: '.WEB_BASE);
